...
images:
  - src: "../../assets/images/recipes/sourdough-pizza-crust--baked.jpg"
    ...
    metadata:
      Tool: "Oven"
      Temp: "475°F"
      Cheese: "Fresh, low moisture mozzarella"
...
<StepGallery items={props.stepItems.filter(item => item.src.includes('slice') || item.src.includes('baked'))} label="Results" client:visible />
