...
images:
  - src: "../../assets/images/recipes/sourdough-pizza-crust--dough--01.jpg"
    alt: "Dough pre-rise"
    caption: "After mixing, before rise."
    metadata:
      Tool: "Kitchen Aid mixer"
      Flour: "King Arthur Bread Flour"
  - src: "../../assets/images/recipes/sourdough-pizza-crust--dough--02.jpg"
    alt: "Dough post-rise"
...
<BlueprintGallery items={props.galleryItems.filter(item => item.src.includes('dough'))} label="Hydration & Mixing" client:visible />
